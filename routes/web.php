...
Route::group(['middleware' => ['auth', 'checkRole:admin,kasir']], function () {
	...
	// ------------------------- Kelola Barang -------------------------
	// > Kategori
	Route::get('/kategori', 'KategoriManageController@viewKategori');
	Route::post('/kategori/create', 'KategoriManageController@createKategori');
	Route::get('/kategori/edit/{id_kategori}', 'KategoriManageController@editKategori');
	Route::post('/kategori/update', 'KategoriManageController@updateKategori');
	Route::get('/kategori/delete/{id_kategori}', 'KategoriManageController@deleteKategori');

	// > Barang
	Route::get('/product', 'ProductManageController@viewProduct');
	Route::get('/product/search', 'ProductManageController@searchProduct');
