						...
						<ul class="list-date" id="list-date-pasok">
							...
							<div class="table-responsive">
								<table class="table table-custom">
									...
									<tr>
										<td class="td-1">
											<span class="d-block font-weight-bold big-font">{{ $supply->kode_barang
												}}</span>
											<span class="d-block mt-2 txt-light">{{ date('d M, Y',
												strtotime($supply->created_at)) . ' pada ' . date('H:i',
												strtotime($supply->created_at)) }}</span>
										</td>
										<td class="td-2 font-weight-bold">{{ $supply->nama_barang }}</td>
										<td class="td-3 font-weight-bold"><span class="ammount-box bg-secondary"><i
							...
							<div class="table-responsive">
								<table class="table table-custom">
									...
									<tr>
										...
										@endphp
										<td class="td-1">
											<span class="d-block font-weight-bold big-font">{{
												$transaction->kode_transaksi }}</span>
											<span class="d-block mt-2 txt-light">{{ date('d M, Y',
												strtotime($tgl_transaksi->created_at)) . ' pada ' . date('H:i',
												strtotime($tgl_transaksi->created_at)) }}</span>
										</td>
									...
									<tr id="dropdownTransaksi{{ $transaction->kode_transaksi }}" data-status="0"
										class="dis-none">
