...
<head>
	<title>Laporan Pemasukan ({{ date('d M, Y', strtotime($tgl_awal)) . ' - ' . date('d M, Y', strtotime($tgl_akhir))}})
	</title>
	<style type="text/css">
		html {
				...
				<tbody>
					...
					<tr>
						<td>
							...
							<span class="text-10 txt-light d-block">Waktu : {{ date('H:i',
								strtotime($transaction->created_at)) }}</span>
						</td>
						<td>
