  ...
  <table class="table table-custom">
    ...
    <tr>
      ...
      <td class="td-1">
        ...
        <span class="d-block mt-2 txt-light">{{ date('d M, Y', strtotime($tgl_transaksi->created_at)) . ' pada ' .
          date('H:i', strtotime($tgl_transaksi->created_at)) }}</span>
      </td>
      ...
      <td colspan="5" class="dropdown-content">
        ...
        <table class="table">
          ...
          <tr>
            ...
            <td><span class="ammount-box-2 bg-secondary"><i class="mdi mdi-cube-outline"></i></span> {{ $product->jumlah
              }}</td>
            <td>
