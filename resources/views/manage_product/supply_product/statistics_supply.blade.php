              ...
              <div class="form-group row">
                <div class="col-lg-8 col-md-8 col-sm-9 col-9">
                  <input type="text" class="form-control" name="kode_barang"
                    value="{{ $products->first()->kode_barang }}" readonly="">
                </div>
                <div class="col-lg-4 col-md-4 col-sm-3 col-3 btn-search-lg" hidden="">
                  <button class="btn btn-search btn-block font-weight-bold" data-toggle="modal"
              ...
              <tbody>
                ...
                <tr>
                  <td data-toggle="tooltip" data-placement="top"
                    title="{{ date('d M, Y', strtotime($supply->created_at)). ' pada ' . date('h:m', strtotime($supply->created_at)) }}">
                    {{ date('d M, Y', strtotime($supply->created_at)) }}</td>
                  ...
                  <td>
                    ...
                    number_format($supply->harga_beli,2,',','.') }}
                  </td>
