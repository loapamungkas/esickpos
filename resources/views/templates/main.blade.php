          ...
          <li class="nav-item dropdown">
            ...
            $jumlah_notif = \App\Product::where('stok', '<', 10) ->count();
              $notifications = \App\Product::where('stok', '<', 10) ->get();
                $notification = \App\Product::where('stok', '<', 10) ->take(3)
                  ->get();
                  @endphp
                  ...
                  <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list pb-0"
                    ...
                    <a class="dropdown-item preview-item py-3">
                      ...
                      <div class="preview-item-content">
                        ...
                        <p class="font-weight-light small-text mb-0"> Stok barang {{ $notif->nama_barang }} telah habis
                        </p>
                      </div>
                    </a>
                    @endif
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="kelola_barang">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item">
                  <a class="nav-link" href="{{ url('/kategori') }}">Daftar Kategori</a>
                </li>
                <li class="nav-item">
                    ...
                    <div class="col-12">
                      ...
                      <div class="d-flex justify-content-start align-items-center mb-3">
                        ...
                        <div class="text-group ml-3">
                          ...
                          <p class="m-0 description-notification">Stok {{ $notif->nama_barang }} tersisa {{ $notif->stok
                            }}</p>
                        </div>
                      </div>
                      @else
        ...
        <footer class="footer" id="footer-content">
          <div class="container-fluid clearfix">
            <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright © 2022 <a
                href="http://www.instagram.com/loapamungkas_" target="_blank">Loa Pamungkas</a>.</span>
          </div>
        </footer>
      </div>
    </div>
